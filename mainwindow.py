...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def connect(self):
        ...
        self.ui.actionFlip.triggered.connect(self.handleFlip)
        self.ui.actionFisheye.triggered.connect(self.handleFisheye)
    ...
    @draw(2)
    def handleFlip(self):
        self.img2 = flip(self.img1)

    @draw(2)
    def handleFisheye(self):
        self.img2 = fisheye(self.img1)
